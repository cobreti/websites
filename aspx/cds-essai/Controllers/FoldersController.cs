...
namespace cds_essai.Controllers
{
    public class FoldersController : ApiController
    {
        ...
        public IDictionary<string, object> Get(string module)
        {
            ...
            ret = GetFolders(module, null, path);
        ...
        public IDictionary<string, object> Get(string module, string path)
        {
            ...
            ret = GetFolders(module, path, _mapping[module] + '/' + path);

            return ret;
        }

        protected IDictionary<string, object> GetFolders(string module, string relPath, string path)
        {
            ...
            var folders = System.IO.Directory.EnumerateDirectories(fullPath);
            var middlePath = "/";
